  ...
  <div class="theme-text space-y-10">
    ...
    <section>
      ...
      <div class="card p-6 space-y-3 text-sm text-white/70">
        ...
        <p><strong class="text-white/90">模型发现</strong>:<code class="text-white/85 font-mono">GET /v1/models</code> 默认返回严格的 OpenAI 标准列表。需要能力元数据时使用 <code class="text-white/70">GET /v1/models?extended=true</code>,每个模型会额外带 <code class="text-white/70">kind</code>(image/video/text)、<code class="text-white/70">supported_ratios</code>、<code class="text-white/70">supported_resolutions</code>、<code class="text-white/70">max_reference_images</code> 和 <code class="text-white/70">reference_mode</code>;视频模型还带 <code class="text-white/70">supported_durations</code>(如 <code class="text-white/70">["5s"]</code>),即 <code class="text-white/70">seconds</code> 可传的档位。</p>
